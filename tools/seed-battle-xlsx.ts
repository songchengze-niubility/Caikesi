...
const LEVELS_ROWS: (string | number)[][] = [
    ...
    [6, '第7关 · 壁垒', 1.6, 'c1_late', 0, 'zombie', 12, 0.4,  770],
    [6, '第7关 · 壁垒', 1.6, 'c1_late', 1, 'brute',  4,  1.2,  2168],
    [6, '第7关 · 壁垒', 1.6, 'c1_late', 2, 'runner', 12, 0.4,  426],
    [6, '第7关 · 壁垒', 1.6, 'c1_late', 3, 'brute',  4,  1.2,  2168],
    [6, '第7关 · 壁垒', 1.6, 'c1_late', 3, 'zombie', 10, 0.4,  770],
    [6, '第7关 · 壁垒', 1.6, 'c1_late', 4, 'brute',  2,  1.4,  2168],
    [6, '第7关 · 壁垒', 1.6, 'c1_late', 4, 'runner', 6,  0.6,  426],
    ...
    [9, '第10关 · 屠夫领主', 1.8, 'c1_boss', 0, 'zombie', 14, 0.35, 805],
    [9, '第10关 · 屠夫领主', 1.8, 'c1_boss', 1, 'runner', 12, 0.4,  405],
    [9, '第10关 · 屠夫领主', 1.8, 'c1_boss', 2, 'brute',  4,  1.2,  2015],
    [9, '第10关 · 屠夫领主', 1.8, 'c1_boss', 3, 'zombie', 12, 0.4,  805],
    [9, '第10关 · 屠夫领主', 1.8, 'c1_boss', 3, 'runner', 8,  0.5,  405],
    [9, '第10关 · 屠夫领主', 1.8, 'c1_boss', 4, 'boss_butcher', 1, 1.0, 36000],
    [9, '第10关 · 屠夫领主', 1.8, 'c1_boss', 4, 'runner', 6,  0.8,  405],
];
