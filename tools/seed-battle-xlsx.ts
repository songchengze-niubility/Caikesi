...
const ENEMY_ROWS: (string | number)[][] = [
    ...
    ['boss_butcher', '屠夫领主', 40, 60, 1.5, '150,40,40', 10800, 55, 20, 0, 0.8, 0.05, 0.5, 0.0, 0.0, 0.0, 0.0, 0.30],
];
...
const LEVELS_ROWS: (string | number)[][] = [
    ...
    [3, '第4关 · 铁壁', 1.8, 'c1_mid', 0, 'zombie', 10, 0.5,  330],
    [3, '第4关 · 铁壁', 1.8, 'c1_mid', 1, 'brute',  4,  1.3,  790],
    [3, '第4关 · 铁壁', 1.8, 'c1_mid', 2, 'brute',  3,  1.4,  790],
    [3, '第4关 · 铁壁', 1.8, 'c1_mid', 2, 'runner', 6,  0.8,  155],
    [3, '第4关 · 铁壁', 1.8, 'c1_mid', 3, 'brute',  4,  1.2,  1010],
    [3, '第4关 · 铁壁', 1.8, 'c1_mid', 3, 'zombie', 8,  0.4,  330],
    // 第5关 · 缓坡
    [4, '第5关 · 缓坡', 1.8, 'c1_mid', 0, 'zombie', 14, 0.45, 300],
    [4, '第5关 · 缓坡', 1.8, 'c1_mid', 1, 'runner', 10, 0.5,  180],
    [4, '第5关 · 缓坡', 1.8, 'c1_mid', 2, 'brute',  3,  1.4,  920],
    [4, '第5关 · 缓坡', 1.8, 'c1_mid', 2, 'zombie', 10, 0.4,  300],
    [4, '第5关 · 缓坡', 1.8, 'c1_mid', 3, 'brute',  2,  1.5,  920],
    [4, '第5关 · 缓坡', 1.8, 'c1_mid', 3, 'runner', 10, 0.5,  180],
    // 第6关 · 夹击
    [5, '第6关 · 夹击', 1.8, 'c1_mid', 0, 'runner', 12, 0.4,  155],
    [5, '第6关 · 夹击', 1.8, 'c1_mid', 1, 'zombie', 14, 0.4,  275],
    [5, '第6关 · 夹击', 1.8, 'c1_mid', 2, 'brute',  4,  1.3,  780],
    [5, '第6关 · 夹击', 1.8, 'c1_mid', 2, 'runner', 6,  0.7,  155],
    [5, '第6关 · 夹击', 1.8, 'c1_mid', 3, 'brute',  3,  1.4,  780],
    [5, '第6关 · 夹击', 1.8, 'c1_mid', 3, 'zombie', 12, 0.4,  275],
    // 第7关 · 壁垒（台阶二：检查 4~6 段装备 + 合成；1~3 段装卡关）
    [6, '第7关 · 壁垒', 1.6, 'c1_late', 0, 'zombie', 12, 0.4,  480],
    [6, '第7关 · 壁垒', 1.6, 'c1_late', 1, 'brute',  4,  1.2,  1345],
    [6, '第7关 · 壁垒', 1.6, 'c1_late', 2, 'runner', 12, 0.4,  265],
    [6, '第7关 · 壁垒', 1.6, 'c1_late', 3, 'brute',  4,  1.2,  1345],
    [6, '第7关 · 壁垒', 1.6, 'c1_late', 3, 'zombie', 10, 0.4,  480],
    [6, '第7关 · 壁垒', 1.6, 'c1_late', 4, 'brute',  2,  1.4,  1345],
    [6, '第7关 · 壁垒', 1.6, 'c1_late', 4, 'runner', 6,  0.6,  265],
    // 第8关 · 风暴（快速刷怪波并发压力大，hp 系数低于 L9）
    [7, '第8关 · 风暴', 1.6, 'c1_late', 0, 'runner', 14, 0.35, 200],
    [7, '第8关 · 风暴', 1.6, 'c1_late', 1, 'zombie', 16, 0.35, 360],
    [7, '第8关 · 风暴', 1.6, 'c1_late', 2, 'brute',  4,  1.2,  1010],
    [7, '第8关 · 风暴', 1.6, 'c1_late', 3, 'zombie', 12, 0.4,  360],
    [7, '第8关 · 风暴', 1.6, 'c1_late', 3, 'runner', 8,  0.5,  200],
    [7, '第8关 · 风暴', 1.6, 'c1_late', 4, 'brute',  3,  1.3,  1010],
    [7, '第8关 · 风暴', 1.6, 'c1_late', 4, 'runner', 6,  0.6,  200],
    // 第9关 · 黑潮
    [8, '第9关 · 黑潮', 1.6, 'c1_late', 0, 'zombie', 14, 0.35, 420],
    [8, '第9关 · 黑潮', 1.6, 'c1_late', 1, 'brute',  4,  1.2,  1140],
    [8, '第9关 · 黑潮', 1.6, 'c1_late', 2, 'runner', 14, 0.35, 230],
    [8, '第9关 · 黑潮', 1.6, 'c1_late', 3, 'brute',  4,  1.2,  1140],
    [8, '第9关 · 黑潮', 1.6, 'c1_late', 3, 'zombie', 10, 0.4,  420],
    [8, '第9关 · 黑潮', 1.6, 'c1_late', 4, 'brute',  2,  1.4,  1140],
    [8, '第9关 · 黑潮', 1.6, 'c1_late', 4, 'runner', 8,  0.5,  230],
    // 第10关 · 屠夫领主（台阶三：4 普通波 + Boss 波；4~6 段装卡关）
    [9, '第10关 · 屠夫领主', 1.8, 'c1_boss', 0, 'zombie', 14, 0.35, 575],
    [9, '第10关 · 屠夫领主', 1.8, 'c1_boss', 1, 'runner', 12, 0.4,  290],
    [9, '第10关 · 屠夫领主', 1.8, 'c1_boss', 2, 'brute',  4,  1.2,  1440],
    [9, '第10关 · 屠夫领主', 1.8, 'c1_boss', 3, 'zombie', 12, 0.4,  575],
    [9, '第10关 · 屠夫领主', 1.8, 'c1_boss', 3, 'runner', 8,  0.5,  290],
    [9, '第10关 · 屠夫领主', 1.8, 'c1_boss', 4, 'boss_butcher', 1, 1.0, ''],
    [9, '第10关 · 屠夫领主', 1.8, 'c1_boss', 4, 'runner', 6,  0.8,  290],
];
